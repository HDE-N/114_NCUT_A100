...
class GRUModel(nn.Module):
    def __init__(self, input_dim=1, hidden=128, layers=2, num_classes=3):
        ...
        # 輸出維度為 3 (notTired=0, Tired=1, other=2)
...
def main():
    ...
    # ===== 資料載入 =====
    # Label 0: notTired, Label 1: Tired, Label 2: other
    
    # 訓練集 (皆使用相同的 target_columns)
    ...
    # 使用 CrossEntropyLoss (支援多類別與權重平衡)
